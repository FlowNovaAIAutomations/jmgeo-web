...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "JM GEO. Captura de datos LiDAR aéreos con drones para topografía técnica de precisión en seis países europeos." },
      { property: "og:site_name", content: "JM GEO" },
      ...
      { name: "twitter:title", content: "JM GEO · Topografía con drones y LiDAR" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Geist:wght@300;400;500;600&family=Inter:wght@300;400;500;600&display=swap",
      },
    ],
    scripts: [
      {
